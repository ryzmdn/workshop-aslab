<?php
    ...
    $cek = mysqli_query($koneksi, "SELECT nidn FROM dosen WHERE nidn='$nidn'");
    if (mysqli_num_rows($cek) > 0) {
        $error_msg = "NIDN sudah terdaftar!";
    } else {
        ...
        if (mysqli_query($koneksi, $query)) {
            ...
            $success_msg = "Data dosen berhasil ditambahkan! User login: $username / $nidn";
        } else {
    ...
    if (mysqli_query($koneksi, "DELETE FROM dosen WHERE nidn='$nidn'")) {
        $success_msg = "Data dosen berhasil dihapus!";
    } else {
        $error_msg = "Error: " . mysqli_error($koneksi);
    }
    }
    ...
    if (mysqli_query($koneksi, "UPDATE dosen SET nama='$nama' WHERE nidn='$nidn'")) {
        $success_msg = "Data dosen berhasil diupdate!";
    } else {
        $error_msg = "Error: " . mysqli_error($koneksi);
    }
    }
            ...
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    <?php
                        ...
                        if (! $data) {
                            echo "<tr><td colspan='3' class='text-center text-danger'>Error: " . mysqli_error($koneksi) . "</td></tr>";
                        } elseif (mysqli_num_rows($data) == 0) {
                            echo "<tr><td colspan='3' class='text-center'>Belum ada data dosen</td></tr>";
                        } else {
